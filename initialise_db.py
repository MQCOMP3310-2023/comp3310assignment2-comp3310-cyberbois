...
def populate_db():
   # Delete all menu items
    ...
    session.add(menu_item1) # Renamed variable 'menuItem1' to match regular expression
    session.commit()
    ...
    session.add(menu_item2) # Renamed variable 'menuItem2' to match regular expression
    session.commit()
    ...
    session.add(menu_item3) # Renamed variable 'menuItem3' to match regular expression
    session.commit()
    ...
    session.add(menu_item4) # Renamed variable 'menuItem4' to match regular expression
    session.commit()
    ...
    session.add(menu_item5) # Renamed variable 'menuItem5' to match regular expression
    session.commit()

    menu_item6 = MenuItem(name="Iced Tea", description="with Lemon",
                          price="$.99", course="Beverage", restaurant=restaurant1)
    session.add(menu_item6) # Renamed variable 'menuItem6' to match regular expression
    session.commit()
    ...
    session.add(menu_item7) # Renamed variable 'menuItem7' to match regular expression
    session.commit()
    ...
    session.add(menu_item8) # Renamed variable 'menuItem8' to match regular expression
    session.commit() 
    ...
    session.add(menu_item9) # Renamed variable 'menuItem9' to match regular expression
    session.commit()
